/*! Wireframe Kit runtime v1.0.2 — 表紙・コメント・PNG書き出し */
(function(){
...
function save(){try{LS.setItem(STORE,JSON.stringify(comments));}catch(e){alert('ブラウザの保存容量がいっぱいです。画像付きのコメントを減らしてください。');}}
