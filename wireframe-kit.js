/*! Wireframe Kit runtime v1.1.1 — 表紙・コメント・PNG書き出し */
(function(){
...
window.addEventListener('load',()=>{wfAnchorFix();if(location.hash){const el=document.getElementById(decodeURIComponent(location.hash.slice(1)));if(el)el.scrollIntoView({behavior:'instant'});}});
